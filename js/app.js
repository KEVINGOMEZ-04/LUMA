...
class LumaApp {
  ...
  bindSubscriptions() {
    // Suscripción a cambios en Storage
  ...
  checkInitialState() {
    ...
    if (!profile || !profile.name || !groups || groups.length === 0 || !activeGroup) {
      ...
      // Conectar presencia al grupo activo
  ...
  renderMovies() {
    ...
    movies.forEach(movie => {
      ...
      // Generar chips de notas individuales de miembros
